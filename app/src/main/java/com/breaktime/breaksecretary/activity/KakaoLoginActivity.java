...
//import com.breaktime.breaksecretary.databinding.ActivityKakaoLoginBinding;
...
//
//    private static final String TAG = "LOG_KAKAO";
//
...
//    ImageView imageView;
//
//    ActivityKakaoLoginBinding binding;
//
//    @Override
...
//
//        binding = DataBindingUtil.setContentView(this, R.layout.activity_kakao_login);
...
//                try {
//                    Log.d(TAG, "getFirebaseJwt onResponse");
...
//                Log.d(TAG, "getFirebaseJwt Response.Error");
...
//            Log.d(TAG, "kakaosessioncallback onsessionopend");
...
////            String accessToken = Session.getCurrentSession().getTokenInfo().toString();
...
//            Log.d(TAG, "kakaosession onsessionopenfailed");
//            if (exception != null) {
